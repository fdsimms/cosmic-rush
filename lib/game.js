(function () {
  ...
  Game.prototype.draw = function (ctx) {
    ...
    ctx.drawImage(background, 0, this.tick % Game.DIM_Y);
    ctx.drawImage(background, 0, this.tick % Game.DIM_Y - Game.DIM_Y);
    ctx.drawImage(background, 0, this.tick % Game.DIM_Y - Game.DIM_Y / 2);
    ctx.drawImage(background, 800, this.tick % Game.DIM_Y);
    ctx.drawImage(background, 800, this.tick % Game.DIM_Y - Game.DIM_Y);
    ctx.drawImage(background, 800, this.tick % Game.DIM_Y - Game.DIM_Y / 2);
