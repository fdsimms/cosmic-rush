(function () {
  ...
  Game.prototype.startAlienFire = function () {
    ...
    var numIntervals = Math.floor(1 + this.curLevel / 3);
    for (var i = 0; i < numIntervals; i++) {
      this.setAlienFireInterval();
    }

    var alienFire1 = setInterval(function () {
      var rand = Math.floor(Math.random() * this.aliens.length);
      if (document.hasFocus()) {
        this.aliens[rand].fireBullet.call(this.aliens[rand]);
      }
    ...
    var alienFire2 = setInterval(function () {
      var rand = Math.floor(Math.random() * this.aliens.length);
      if (document.hasFocus()) {
        this.aliens[rand].fireBullet.call(this.aliens[rand]);
      }
    ...
    this.alienFireIntervals.push(alienFire1);
    this.alienFireIntervals.push(alienFire2);
  };
